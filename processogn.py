...
while True:                                 # until end of file
    ...
    if ((hostname == "CHILEOGN" or hostname == "OGNCHILE") and source == "OGN") or source == "SPOT" or spanishsta(station) or frenchsta(station):  # only Chilean or Spanish or frenchstations
